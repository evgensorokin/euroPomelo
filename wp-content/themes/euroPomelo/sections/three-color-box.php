...
<section class="color-res">
    <?php while ( have_rows('sections') ) : the_row(); if( get_row_layout() == 'third_color_box' ):  $rows = get_sub_field('color_boxes'); ?>
            ...
            <div class="container res-box">
                <div class="row">
                    <?php while ( have_rows('color_boxes') ) : the_row(); ?>
                        <div class="col-sm-4 item" style="background-color: <?php the_sub_field('color_item'); ?>">
                            <div>
